<?php
    /*
        Template Name: Home Page - Com perguntas frequentes
    */
?>
...
<main>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-6">
                    <h1 class="hero-title text-uppercase font-weight-bold">
                        <span class="font-size-80">O seguro para</span>
                        <br>
                        <span class="font-size-172 hero-bigger" data-text="CUIDAR">Cuidar</span>
                        <br>
                        <span class="font-size-8.b0">Do seu veículo</span>
                    </h1>
                    <p class="py-40 d-none d-lg-block">
    ...
    <div class="d-none d-lg-block fake-divisor-wrapper"></div>

    <!--        Por que a kaprice        -->

    <section class="wrapper-why-kaprice bg-danger text-white">
        <div class="container py-30 py-xl-65">
    ...
    <!-- Seguro para você -->
    <?php require 'includes/seguro-para-voce.php'?>
<!--    Fim Seguro para você-->
    ...
    <section class="">
        ...
        <div style="background: black" class="pb-50 pb-xl-0">
            <div class="container">
                <div class="security-for-company-wrapper-group-slick">
                    <?php foreach (Data::securityForCompany() as $securityForYou) : ?>
                        <div class="security-for-company d-flex flex-column align-items-center justify-content-center">
                            ...
                            <p class="d-none d-lg-block text text-white">
                                <?= $securityForYou['text'] ?>
                            </p>
    ...
    <?php
        ...
        require_once 'includes/duvidas-frequentes.php';
